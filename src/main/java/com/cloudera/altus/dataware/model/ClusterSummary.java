...
import com.cloudera.altus.dataware.model.ClusterSummarySecurityConfiguration;
...
public class ClusterSummary  {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clusterName, crn, creationDate, status, cdhVersion, instanceType, workersGroupSize, environmentType, environmentCrn, securityConfiguration, namespaceCrn, publicIpsAssociated);
  }
